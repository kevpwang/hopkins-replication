...
parameters <- tibble(condition = c("Accented English", "Fluent Spanish", "No Video"),
...
ggplot(parameters, aes(x = condition, y = coef)) +
  ...
  labs(
    ...
    caption = "Support measured numerically from 1 (strongly oppose) to 4 (strongly support)."
  )
```
